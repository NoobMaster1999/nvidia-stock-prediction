    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">${stats.current_price?.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              <div className="flex items-center justify-between">
                ...
                <TrendingUp className={`h-8 w-8 ${stats.change >= 0 ? 'text-green-400' : 'text-red-400'}`} />
              </div>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">${stats.high_30d?.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-white">${stats.low_30d?.toFixed(2)}</p>
                </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 mb-8">
          <h2 className="text-2xl font-bold text-white mb-6">Price History (Last 30 Days)</h2>
          <div className="h-96">
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
          <h2 className="text-2xl font-bold text-white mb-6">Stock Price Prediction</h2>
          ...
          {prediction && (
            <div className="mt-8 text-center">
              <div className="bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-xl p-6 border border-green-500/30">
                <h3 className="text-lg font-semibold text-white mb-2">Predicted Next Price</h3>
                ...
                {prediction.last_5_prices && (
                  <div className="mt-4">
                    <p className="text-gray-400 text-sm mb-2">Recent prices used:</p>
                    <div className="flex justify-center space-x-2">
                      {prediction.last_5_prices.map((price, index) => (
                        <span key={index} className="bg-white/10 px-3 py-1 rounded text-sm text-gray-300">
                          ${price.toFixed(2)}
                        </span>
                      ))}
                    </div>
